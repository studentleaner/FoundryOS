...
This document contains representations of the core flows within the Strategic Intelligence Engine (SIE). 
...
```mermaid
graph TD
    subgraph Execution OS (Builder Muscle)
