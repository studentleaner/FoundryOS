...
The SIE evaluates startups by deconstructing them into fundamental, measurable risk vectors. If a risk vector exceeds acceptable parameters, the system penalizes the project's overall viability score.
...
## The Composite Score
All vectors are aggregated into the **SIE Viability Index (0-100)**. 
