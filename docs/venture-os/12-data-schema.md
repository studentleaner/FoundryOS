...
Because ideas evolve as they iterate through the Personal Strategic Mode (PSM), the VentureOS is not a stateless calculator. It is a persistent database built to query how ideas improve or decay over time.

---

## 1. The Core Principle: Ideas Have Version History

When a founder realizes their initial idea has a weak moat, they will pivot the business architecture and re-submit it. The VentureOS tracks the exact delta between `Idea v1` and `Idea v2` to visually graph the strengthening of the strategic concept.
